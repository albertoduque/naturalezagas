    ...
    <div class="col-sm-6">
                <div class="input-group">
                    ...
                    <div class="form-group label-floating">
                         <?= $form->field($model, 'tipo_documento')->dropDownList(['1'=>'CEDULA CIUDADANIA','2'=>'CEDULA DE EXTRANJERIA','3'=>'PASAPORTE'],['prompt'=>'NINGUNO']); ?>
            ...
            <div class="col-sm-6">
                <div class="input-group">
                <div class="form-group label-floating">
                    <?= $form->field($model, 'identificacion')->textInput(['type' => 'number'],['maxlength' => false])->label('Identificación') ?>   
                </div>
                    </div>
            </div>
    <div class="col-sm-12">
                ...
                <div class="form-group label-floating">
                    <div class="form-group2">
                        <?php Pjax::begin(['id' => 'personas-pais-dropDownList']);   ?>
                            <?= $form->field($model, 'pais')->dropDownList($listPais,['prompt'=>'Pais','class'=>'dropDownList form-control','data-preview'=>'personas-id_ciudad','data-set'=>'pais','data-url'=>Url::toRoute(['ciudad/to-list-ciudad'])])->label('País') ?>
                        <?php Pjax::end(); ?>
                    </div>
                </div>
        </div>
       ...
       <div class="col-sm-12">
         ...
         <div class="col-sm-12">
                <div class="input-group">
                     ...
                     <div class="form-group label-floating">
                             <?= $form->field($model, 'id_tipo_asistente')->dropdownList($listAsistente,['options'=>['31'=>['Selected'=>true]]])->label("Asistente"); ?>
                     </div>
                </div>
            </div>
</div>
